...
public class Tilebg extends ImageView {
	...
	public Tilebg(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
	}
	...
	protected void onAttachedToWindow() {
		...
		if (!mAttached) {
			...
			filter.addAction("TileColorblast");
	...
	private final BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (action.equals("TileColorblast")) {
				updateCarrier();
	...
	protected void updateCarrier() {
		...
		if(p.contains("pngtile")){
			setBackgroundColor(p.getInt("pngtile", 000000));
		}
