...
import android.widget.Toast;
	...
	public class Clocktextcolorpick extends Activity implements OnColorChangedListener {
		  ...
		  private ColorPicker picker;
			...
			protected void startcolorchange() {
						...
						edit.putInt("Clocktextpng",color);
						edit.commit();
						Intent send = new Intent();
						send.setAction("ClockTextColorblast");
						sendBroadcast(send);
