...
import android.widget.Toast;
	...
	public class Tiletextcolorpick extends Activity implements OnColorChangedListener {
		  ...
		  private ColorPicker picker;
			...
			protected void startcolorchange() {
						...
						edit.putInt("Tiletextpng",color);
						edit.commit();
						Intent send = new Intent();
						send.setAction("TileTextColorblast");
						sendBroadcast(send);
