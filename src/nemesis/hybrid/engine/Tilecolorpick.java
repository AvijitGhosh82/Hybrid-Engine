...
import android.widget.Toast;
	...
	public class Tilecolorpick extends Activity implements OnColorChangedListener {
		  ...
		  private ColorPicker picker;
			...
			protected void startcolorchange() {
						...
						edit.putInt("pngtile",color);
						edit.commit();
						Intent send = new Intent();
						send.setAction("TileColorblast");
						sendBroadcast(send);
