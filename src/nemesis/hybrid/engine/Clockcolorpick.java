...
import android.widget.Toast;
	...
	public class Clockcolorpick extends Activity implements OnColorChangedListener {
		  ...
		  private ColorPicker picker;
			...
			protected void startcolorchange() {
						...
						edit.putInt("Clockpng",color);
						edit.commit();
						Intent send = new Intent();
						send.setAction("ClockColorblast");
						sendBroadcast(send);
