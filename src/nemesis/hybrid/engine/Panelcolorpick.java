...
import android.widget.Toast;
	...
	public class Panelcolorpick extends Activity implements OnColorChangedListener {
		  ...
		  private ColorPicker picker;
			...
			protected void startcolorchange() {
						...
						edit.putInt("Panelpng",color);
						edit.commit();
						Intent send = new Intent();
						send.setAction("PanelColorblast");
						sendBroadcast(send);
