...
public class Clocktextbg extends ImageView {
	private Context context;
	private boolean mAttached;

	public Clocktextbg(Context context) {
		super(context);
		this.context = context;

	}

	public Clocktextbg(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
	}
	...
	protected void updateCarrier() {
		...
		if(p.contains("Clocktextpng")){
			setBackgroundColor(p.getInt("Clocktextpng", 17170443));
		}
